...
for generating dense or sparse matrix you only have to comment one of the lines
21 and 24 in genStructure.m file in sparse case you have to specify the value 
of desired density.
